...
exports.getRegisteredHotkeys = exports.deregisterHotkey = exports.registerHotkey = exports.checkHotkey = exports.shallowEqual = exports.exceptionsReplace = exports.getBaseModifiersMap = exports.isArray = exports.getModifiersFromEvent = exports.getModifiers = exports.getModifierPropertyName = exports.isString = exports.getParsed = exports.getSubject = exports.last = exports.getParts = exports.isModifier = void 0;
...
const deregisterHotkey = (hotkey, f) => {
  const b = getBody();
  const existingMatches = f ? registeredHotkeys.filter(o => o.hotkey === hotkey && o.f === f) : registeredHotkeys.filter(o => o.hotkey === hotkey);
  existingMatches.forEach(match => {
    b.removeEventListener('keyup', match.wrappedFunction);
  });
  const newRegisteredHotkeys = f ? registeredHotkeys.filter(o => o.hotkey !== hotkey && o.f !== f) : registeredHotkeys.filter(o => o.hotkey !== hotkey);
  registeredHotkeys = newRegisteredHotkeys;
};

exports.deregisterHotkey = deregisterHotkey;

const getRegisteredHotkeys = () => registeredHotkeys;

exports.getRegisteredHotkeys = getRegisteredHotkeys;